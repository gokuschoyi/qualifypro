...
const Banner = () => {
    return (
        <Box id='home' className='banner-container'>
            <Grid container spacing={2}  p={{ xs: 2, md: 3, lg: 5 }}>
                <Grid item xs={12} sm={12} md={12} lg={8} xl={8} display='flex' alignItems='center'>
                    <Box  className='banner-left-grid'>
                        <Typography variant='h2' fontWeight={100} className='banner-title'>
                        ...
                        <Box className='button-group'>
                            <Button variant="text" style={{ fontSize: '18px', color: `white`, backgroundColor: '#f76e39', marginRight: '20px' }} sx={{
                                ':hover': {
                                    color: 'white !important',
                                    backgroundColor: '#f76e39 !important',
                                },
                            }} >GET STARTED</Button>
                            <Button variant="text" style={{ fontSize: '18px', color: `white`, backgroundColor: '#f76e39', }} sx={{
                                ':hover': {
                                    color: 'white !important',
                                    backgroundColor: '#f76e39 !important',
                                },
